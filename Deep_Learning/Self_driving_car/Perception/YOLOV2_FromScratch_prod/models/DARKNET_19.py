#The input is a (416, 416, 3) image and the output is a (13, 13, 40) tensor. The output is based on S x S x (B * 5 +C).
...
def darknet_model(IMAGE_H, IMAGE_W, TRUE_BOX_BUFFER, BOX, CLASS, GRID_H, GRID_W):
